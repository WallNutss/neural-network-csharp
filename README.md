# Neural Network From Scratch Implementation using C# and .NET Frameworks
I always interested in such understanding how the neural network capable of understanding such complex and should I say non-linear(?) problem 
